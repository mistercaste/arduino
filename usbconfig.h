...
#define  USB_CFG_VENDOR_ID       0xef, 0x17 /* = 0x16c0 = 5824 = voti.nl */
 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0x39, 0x60 /* obdev's shared PID for HIDs */
 ...
 */
#define USB_CFG_VENDOR_NAME     'L','e','n','o','v','o'
...
#define USB_CFG_DEVICE_NAME     'M','o','u','s','e','U','S','B'
